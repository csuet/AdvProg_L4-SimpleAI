...
***/
vector filterWordsByLen(int wordLen, const vector& vocabulary){
    vector ans;
...
{
    char ans;
    map <char, int> candidateWordsAnalysis = countOccurrences(candidateWords);
    ans = findMostFrequentChar(candidateWordsAnalysis,selectedChars);
    return ans;
}
